            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-5 ml-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-title-lg font-bold leading-tight ${
                    ...
                    <span className="text-label-sm font-black text-gray-400 uppercase tracking-widest flex items-center gap-1">
                      <IoCalendarClearOutline size={12} className="mb-0.5" />{" "}
                      {t.start_date} • {t.format}
                    </span>
                  </div>
                </div>

                <div
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-label-sm font-bold transition-all ${
                    isOpen
                ...
                >
                  DETAILS{" "}
                  {isOpen ? (
                    <IoChevronUp size={16} className="text-brand-primary" />
                  ) : (
                  ...
                  {loadingMatches ? (
                    ...
                    <>
                      <div className="grid grid-cols-3 py-3 bg-surface-card text-label-sm font-black text-gray-400 uppercase tracking-widest border-b border-gray-50">
                        ...
                        <div className="col-span-2 text-center -ml-20">
                          Matchup
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col">
                          {matches.map((m) => {
                            ...
                            return (
                              <div
                                key={m.id}
                                className="grid grid-cols-3 items-center py-6 border-b border-gray-50 last:border-0 hover:bg-gray-50/30 transition-colors"
                              >
                                ...
                                <div className="col-span-2 flex items-center justify-center gap-8 -ml-20">
                                  ...
                                  <div className="flex flex-col items-center min-w-[70px]">
                                    <span className="text-gray-300 text-label-sm font-bold italic uppercase">
                                      vs
                                    </span>
