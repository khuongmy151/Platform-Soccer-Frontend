      ...
      <div className="flex w-full h-screen overflow-hidden">
        ...
        <div className="flex flex-1 flex-col justify-center items-center px-10 bg-white">
          <div className="w-full max-w-[440px]">
            <h1 className="text-5xl font-black text-slate-900 mb-2 tracking-tight">Welcome</h1>
            <p className="text-slate-500 font-medium mb-10 text-sm">Enter your credentials to access the Arena.</p>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              {/* Email Input */}
              <div className="group">
                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[2px] mb-2 group-focus-within:text-[#FF0000]">Email Address</label>
              ...
              {/* Password Input */}
              <div className="group">
                <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[2px] mb-2 group-focus-within:text-[#FF0000]">Password</label>
                <div className="flex items-center border-b border-slate-200 py-2 group-focus-within:border-[#FF0000] transition-colors">
              ...
              <div className="flex items-center justify-between pt-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 accent-[#FF0000] rounded border-slate-300" />
                  <span className="text-xs font-bold text-slate-500">Remember me</span>
                </label>
                <Link to="/forgot-password" virtual="true" className="text-xs font-black text-[#FF0000] hover:underline">Forgot Password?</Link>
              </div>
            ...
            <p className="mt-12 text-center text-slate-400 font-bold text-xs uppercase tracking-tighter">
              Don't have an account? <Link to="/register" className="text-[#FF0000] hover:underline decoration-2 ml-1">Create an account</Link>
            </p>
          </div>
        </div>
      </div>
