...
const ListTournament = () => {
  ...
  const fetchTournaments = async () => {
    try {
      ...
      setError(
        "Không thể tải danh sách giải đấu. Vui lòng kiểm tra kết nối hoặc thử lại sau."
      );
          ...
          >
            ...
            <div className="w-full h-48 bg-slate-100 rounded-xl mb-4 overflow-hidden relative">
              ...
              <div className="absolute top-3 right-3">
                <span
                  className={`px-3 py-1 rounded-full text-xs font-bold border shadow-sm backdrop-blur-sm bg-opacity-90 ${statusConfig.color}`}
                >
                  {statusConfig.label}
                </span>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              <h3
                className="text-xl font-black text-slate-800 mb-2 line-clamp-1"
